...
cmd-k down	pane:split-down-and-copy-active-item	Core	body
...
ctrl-b	native!	Core	body .native-key-bindings
...
ctrl-shift-cmd-G	styleguide:show	Styleguide	.platform-darwin
